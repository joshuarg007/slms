    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h3 className="font-semibold text-gray-900 dark:text-white">AI Team Performance Analysis</h3>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400">
                  BETA
                </span>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Our behavioral ML models analyze collaboration patterns and suggest optimal team structures.
              </p>
              <div className="flex flex-wrap gap-6 text-sm">
                <div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white">87%</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Team Efficiency Score</div>
                </div>
                <div>
                  <div className="text-lg font-bold text-green-600 dark:text-green-400">+23%</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">vs. Industry Avg</div>
                </div>
                <div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white">4.2</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Optimal Team Size</div>
                </div>
              </div>
            </div>
          </div>
          <Link
            to="/app/chat"
            className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-colors flex-shrink-0"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
          <div className="flex items-start gap-2 text-sm">
            ...
            <span className="text-gray-600 dark:text-gray-400">
              ...
              Your team's permission structure is well-balanced. Consider adding 1-2 more users to optimize workload distribution based on current lead volume projections.
            </span>
          </div>
        </div>
      </div>
